...
let handler = async (m, { conn, text, command, usedPrefix }) => {
    if (!text) return conn.reply(m.chat, `╭─🍓 *『 𝐅𝐑𝐄𝐒𝐈𝐓𝐀 𝐁𝐎𝐓 』* 🍓
...
│
│ > *“Música extraída de la casita dulce”* 🍰
╰─────────────────❒`
...
│
│ > *“El video fue extraído por fresita”* 🍓
╰─────────────────❒`
...
│ 📅 *Fecha:* ${date}
│
│ > *“Archivo extraído de la nube fresita”* 🍓
╰─────────────────❒`
